...
if __name__ == '__main__':
    ...
    test_f1_macro = f1_score(labels[test_idx].cpu(), test_logits[test_idx].argmax(dim=1).cpu(), average='macro')
    test_f1_micro = f1_score(labels[test_idx].cpu(), test_logits[test_idx].argmax(dim=1).cpu(), average='micro')

    print("Test Acc: {:.4f} Test F1_macro: {:.4f} Test F1_micro: {:.4f}".format(test_acc, test_f1_macro, test_f1_micro))
